...
export const FOODS: FoodType[] = [
  ...
  },
  {
    ...
    description: "Flame stacks. Max level unlocks a radial blast.",
    heal: 6,
    stackValue: 1,
    spawnWeight: 3,
    rare: true,
  ...
  },
  {
    ...
    color: "#8be5ff",
    power: "ice",
    powerName: "Ice Fusion",
    description: "Adds slow and mixes with fire into obsidian.",
    heal: 7,
    stackValue: 1,
    spawnWeight: 2,
    rare: true,
...
export const EVOLUTION_PATHS = [
  { id: "fire", name: "Fire", steps: ["Spark", "Flame", "Inferno"], combo: "Inferno triggers radial blast." },
  { id: "ice", name: "Ice", steps: ["Chill", "Freeze", "Blizzard"], combo: "Ice attacks slow enemies hard." },
  { id: "obsidian", name: "Obsidian", steps: ["Ember Frost", "Glass Fang", "Obsidian Core"], combo: "Fire + Ice creates piercing obsidian shots." },
  { id: "seed", name: "Seed", steps: ["Seedling", "Volley", "Thornstorm"], combo: "Wide spread crowd control." },
  { id: "speed", name: "Speed", steps: ["Dash", "Blitz", "Storm Paw"], combo: "Long-range precision pressure." },
  { id: "shield", name: "Guard", steps: ["Guard", "Bulwark", "Fortress"], combo: "Tanky close shots and safer pickups." },
]
